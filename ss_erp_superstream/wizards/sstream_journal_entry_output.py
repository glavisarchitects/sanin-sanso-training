...
class SStreamJournalEntryOutput(models.TransientModel):
    ...
    def query_pattern4_sanhot(self, param):
        ...
        _select_data = f""" 
            WITH odoo_journal_linkage AS (
                SELECT * FROM ss_erp_superstream_linkage_journal where journal_creation = 'sanhot_point'								
            ),
        ...
        """
        self._cr.execute(_select_data)
        data_pattern4_sanhot = self._cr.dictfetchall()
        return data_pattern4_sanhot
...
"""
    ...
    def export_sstream_journal_entry(self):
        ...
        pattern4_data_sanhot = self.query_pattern4_sanhot(param)
        #
        pattern5_data = self.query_pattern5(param)

        # all_pattern_data = pattern3_data
        all_pattern_data = pattern12_data + pattern3_data_debit + pattern3_data_credit + pattern4_data_sanhot+ pattern5_data
